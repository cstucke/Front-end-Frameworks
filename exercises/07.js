...
const titles = movies.map((movie) => movie.title);// your code here

// 2. Get all Sci-Fi movies.
const sciFiMovies = movies.filter((movie) => movie.genre === "Sci-Fi"); // your code here

// 3. Get all movies rated 8.5 or above.
const highRated = movies.filter((movie) => movie.rating >= 8.5); // your code here

// 4. Find the movie titled "Parasite".
const parasite = movies.find((movie) => movie.title === "Parasite");// your code here

// 5. Check if any movie has a rating above 9.5.
const hasOver9_5 = movies.some((movie) => movie.rating > 9.5);// your code here

// 6. Get the titles of all Sci-Fi movies rated above 8.0 (chain filter and map).
const sciFiTitles = movies.filter((movie) => movie.genre === "Sci-Fi" && movie.rating >8.0)
.map((movie) => movie.title);// your code here

// 7. Build a string listing all titles separated by " | "
//    Expected: "Inception | The Dark Knight | Interstellar | ..."
const titleString = movies.map((movie) => movie.title).join(" | ");// your code here
...
const sorted = [...movies].sort((a, b) => b.rating - a.rating);// your code here
